...
#define CONFIG_HOST_TYPE "x86_64-portbld-freebsd11.4"
...
#define HAVE_KRB5_GET_ERR_TEXT 1
...
#define PACKAGE_STRING "Squid Web Proxy 4.15"
...
/* "Define to 1 if the SSL_get_new_ex_index() dup callback accepts 'const
   CRYPTO_EX_DATA *'" */
#define SQUID_USE_CONST_CRYPTO_EX_DATA_DUP 1
